...
@Table(name = "ast_CfgDocIndividual_M")
@Entity
@NamedQueries({ @javax.persistence.NamedQuery(name = "CfgDocIndividual.DefaultFinders", query = "select e from CfgDocIndividual e where e.systemInfo.activeStatus=1 and e.documentId LIKE :documentId and e.residenceTypeId LIKE :residenceTypeId and e.countryId LIKE :countryId"), @javax.persistence.NamedQuery(name = "CfgDocIndividual.findByResidenceTypeId", query = "select e from CfgDocIndividual e where e.systemInfo.activeStatus=1 and e.residenceTypeId=:residenceTypeId"), @javax.persistence.NamedQuery(name = "CfgDocIndividual.findByCountryId", query = "select e from CfgDocIndividual e where e.systemInfo.activeStatus=1 and e.countryId=:countryId"), @javax.persistence.NamedQuery(name = "CfgDocIndividual.findById", query = "select e from CfgDocIndividual e where e.systemInfo.activeStatus=1 and e.documentId =:documentId") })
public class CfgDocIndividual implements Serializable, CommonEntityInterface, Comparator<CfgDocIndividual> {
    ...
    @Override
    public int compare(CfgDocIndividual object1, CfgDocIndividual object2) {
        return 0;
    }
    ...
    public boolean equals(Object obj) {
        try {
            singx.app.shared.singx.CfgDocIndividual other = (singx.app.shared.singx.CfgDocIndividual) obj;
            if (documentId == null) {
                return false;
