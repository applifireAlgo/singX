...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for BankBranch Master table Entity", complexity = Complexity.LOW)
public class BankBranchRepositoryImpl extends SearchInterfaceImpl implements BankBranchRepository<BankBranch> {
    ...
    @Override
    @Transactional
    public List<BankBranch> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.BankBranch> query = emanager.createQuery("select u from BankBranch u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public BankBranch save(BankBranch entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<BankBranch> save(List<BankBranch> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.BankBranch obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.BankBranch s = emanager.find(singx.app.shared.singx.BankBranch.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(BankBranch entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<BankBranch> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.BankBranch obj = entity.get(i);
    ...
    @Transactional
    public List<BankBranch> findByBankId(String bankId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("BankBranch.findByBankId");
            query.setParameter("bankId", bankId);
            java.util.List<singx.app.shared.singx.BankBranch> listOfBankBranch = query.getResultList();
    ...
    @Transactional
    public List<BankBranch> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("BankBranch.findByCountryId");
    ...
    @Transactional
    public BankBranch findById(String branchId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("BankBranch.findById");
            query.setParameter("branchId", branchId);
            singx.app.shared.singx.BankBranch listOfBankBranch = (singx.app.shared.singx.BankBranch) query.getSingleResult();
            return listOfBankBranch;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
