...
public interface ResidenceTypeRepository<T> extends SearchInterface {
    ...
    public T findById(String residencTypeId) throws Exception, SpartanPersistenceException;
}
