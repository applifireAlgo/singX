...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for SingxCity Master table Entity", complexity = Complexity.LOW)
public class SingxCityRepositoryImpl extends SearchInterfaceImpl implements SingxCityRepository<SingxCity> {
    ...
    @Override
    @Transactional
    public List<SingxCity> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.SingxCity> query = emanager.createQuery("select u from SingxCity u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public SingxCity save(SingxCity entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<SingxCity> save(List<SingxCity> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.SingxCity obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.SingxCity s = emanager.find(singx.app.shared.singx.SingxCity.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(SingxCity entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<SingxCity> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.SingxCity obj = entity.get(i);
    ...
    @Transactional
    public List<SingxCity> findByStateId(String stateId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SingxCity.findByStateId");
            query.setParameter("stateId", stateId);
            java.util.List<singx.app.shared.singx.SingxCity> listOfSingxCity = query.getResultList();
            return listOfSingxCity;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public SingxCity findById(String cityId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SingxCity.findById");
            query.setParameter("cityId", cityId);
            singx.app.shared.singx.SingxCity listOfSingxCity = (singx.app.shared.singx.SingxCity) query.getSingleResult();
            return listOfSingxCity;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
