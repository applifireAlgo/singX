...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for ResidenceType Master table Entity", complexity = Complexity.LOW)
public class ResidenceTypeRepositoryImpl extends SearchInterfaceImpl implements ResidenceTypeRepository<ResidenceType> {
    ...
    @Override
    @Transactional
    public List<ResidenceType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.ResidenceType> query = emanager.createQuery("select u from ResidenceType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public ResidenceType save(ResidenceType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<ResidenceType> save(List<ResidenceType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.ResidenceType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.ResidenceType s = emanager.find(singx.app.shared.singx.ResidenceType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(ResidenceType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<ResidenceType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.ResidenceType obj = entity.get(i);
    ...
    @Transactional
    public List<ResidenceType> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("ResidenceType.findByCountryId");
            query.setParameter("countryId", countryId);
            java.util.List<singx.app.shared.singx.ResidenceType> listOfResidenceType = query.getResultList();
            return listOfResidenceType;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public ResidenceType findById(String residencTypeId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("ResidenceType.findById");
            query.setParameter("residencTypeId", residencTypeId);
            singx.app.shared.singx.ResidenceType listOfResidenceType = (singx.app.shared.singx.ResidenceType) query.getSingleResult();
            return listOfResidenceType;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
