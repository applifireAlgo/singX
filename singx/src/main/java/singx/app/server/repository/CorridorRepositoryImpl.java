...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Corridor Master table Entity", complexity = Complexity.LOW)
public class CorridorRepositoryImpl extends SearchInterfaceImpl implements CorridorRepository<Corridor> {
    ...
    @Override
    @Transactional
    public List<Corridor> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.Corridor> query = emanager.createQuery("select u from Corridor u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Corridor save(Corridor entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Corridor> save(List<Corridor> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.Corridor obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.Corridor s = emanager.find(singx.app.shared.singx.Corridor.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Corridor entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Corridor> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.Corridor obj = entity.get(i);
    ...
    @Transactional
    public List<Corridor> findByToCountryId(String toCountryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Corridor.findByToCountryId");
            query.setParameter("toCountryId", toCountryId);
            java.util.List<singx.app.shared.singx.Corridor> listOfCorridor = query.getResultList();
    ...
    @Transactional
    public List<Corridor> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Corridor.findByCountryId");
    ...
    @Transactional
    public Corridor findById(String corridorId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Corridor.findById");
            query.setParameter("corridorId", corridorId);
            singx.app.shared.singx.Corridor listOfCorridor = (singx.app.shared.singx.Corridor) query.getSingleResult();
            return listOfCorridor;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
