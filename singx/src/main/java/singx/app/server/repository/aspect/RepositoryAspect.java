package singx.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* singx.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* singx.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* singx.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* singx.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* singx.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* singx.app.server.repository..*(..))")
