...
import singx.app.shared.authentication.LoginSession;
...
public class LoginSessionRepositoryImpl extends SearchInterfaceImpl implements LoginSessionRepository<LoginSession> {
    ...
    @Override
    @Transactional
    public void saveSession(UserAuthentication userAuthentication, String appSessionId, String appServerSessinId, Timestamp loginTime, Timestamp logOutTime, String ClientIPAddress, Long ClientIPAddressInt, int ClientNetworkAddress, String ClientBrowser, String SessionData) throws SpartanPersistenceException {
        singx.app.shared.authentication.LoginSession loginSession = new singx.app.shared.authentication.LoginSession();
        ...
        loginSession.setSessionData(SessionData);
