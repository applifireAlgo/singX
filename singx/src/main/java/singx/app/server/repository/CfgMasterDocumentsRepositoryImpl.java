...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CfgMasterDocuments Master table Entity", complexity = Complexity.LOW)
public class CfgMasterDocumentsRepositoryImpl extends SearchInterfaceImpl implements CfgMasterDocumentsRepository<CfgMasterDocuments> {
    ...
    @Override
    @Transactional
    public List<CfgMasterDocuments> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.CfgMasterDocuments> query = emanager.createQuery("select u from CfgMasterDocuments u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CfgMasterDocuments save(CfgMasterDocuments entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CfgMasterDocuments> save(List<CfgMasterDocuments> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CfgMasterDocuments obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.CfgMasterDocuments s = emanager.find(singx.app.shared.singx.CfgMasterDocuments.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CfgMasterDocuments entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CfgMasterDocuments> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CfgMasterDocuments obj = entity.get(i);
    ...
    @Transactional
    public CfgMasterDocuments findById(String documentID) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CfgMasterDocuments.findById");
            query.setParameter("documentID", documentID);
            singx.app.shared.singx.CfgMasterDocuments listOfCfgMasterDocuments = (singx.app.shared.singx.CfgMasterDocuments) query.getSingleResult();
            return listOfCfgMasterDocuments;
        } catch (javax.persistence.PersistenceException e) {
