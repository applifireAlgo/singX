...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Bank Transaction table", complexity = Complexity.MEDIUM)
public class BankRepositoryImpl extends SearchInterfaceImpl implements BankRepository<Bank> {
    ...
    @Override
    @Transactional
    public List<Bank> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.Bank> query = emanager.createQuery("select u from Bank u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Bank save(Bank entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.WireTransferMode> wiretransfermode = new java.util.ArrayList<singx.app.shared.singx.WireTransferMode>();
            for (java.util.Iterator iterator = entity.getWireTransferMode().iterator(); iterator.hasNext(); ) {
                singx.app.shared.singx.WireTransferMode childEntity = (singx.app.shared.singx.WireTransferMode) iterator.next();
                if (childEntity.getPrimaryKey() != null) {
                    singx.app.shared.singx.WireTransferMode ans = emanager.find(WireTransferMode.class, childEntity.getPrimaryKey());
                    wiretransfermode.add(ans);
                } else {
                    wiretransfermode.add(childEntity);
                }
            }
            entity.setWireTransferMode(wiretransfermode);
    ...
    @Override
    @Transactional
    public List<Bank> save(List<Bank> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.Bank obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.Bank s = emanager.find(singx.app.shared.singx.Bank.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void deleteWireTransferMode(List<WireTransferMode> wiretransfermode) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (singx.app.shared.singx.WireTransferMode _wiretransfermode : wiretransfermode) {
                singx.app.shared.singx.WireTransferMode s = emanager.find(singx.app.shared.singx.WireTransferMode.class, _wiretransfermode.getWireTransferModeId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    @Transactional
    public List<Bank> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Bank.findByCountryId");
            query.setParameter("countryId", countryId);
            java.util.List<singx.app.shared.singx.Bank> listOfBank = query.getResultList();
            return listOfBank;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public Bank findById(String bankId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Bank.findById");
            query.setParameter("bankId", bankId);
            singx.app.shared.singx.Bank listOfBank = (singx.app.shared.singx.Bank) query.getSingleResult();
            return listOfBank;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
