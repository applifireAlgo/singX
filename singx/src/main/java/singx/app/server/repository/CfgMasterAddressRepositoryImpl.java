...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CfgMasterAddress Master table Entity", complexity = Complexity.LOW)
public class CfgMasterAddressRepositoryImpl extends SearchInterfaceImpl implements CfgMasterAddressRepository<CfgMasterAddress> {
    ...
    @Override
    @Transactional
    public List<CfgMasterAddress> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.CfgMasterAddress> query = emanager.createQuery("select u from CfgMasterAddress u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CfgMasterAddress save(CfgMasterAddress entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CfgMasterAddress> save(List<CfgMasterAddress> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CfgMasterAddress obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.CfgMasterAddress s = emanager.find(singx.app.shared.singx.CfgMasterAddress.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CfgMasterAddress entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CfgMasterAddress> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CfgMasterAddress obj = entity.get(i);
    ...
    @Transactional
    public List<CfgMasterAddress> findByInputTypeId(Integer inputTypeId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CfgMasterAddress.findByInputTypeId");
            query.setParameter("inputTypeId", inputTypeId);
            java.util.List<singx.app.shared.singx.CfgMasterAddress> listOfCfgMasterAddress = query.getResultList();
            return listOfCfgMasterAddress;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public CfgMasterAddress findById(String addressId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CfgMasterAddress.findById");
            query.setParameter("addressId", addressId);
            singx.app.shared.singx.CfgMasterAddress listOfCfgMasterAddress = (singx.app.shared.singx.CfgMasterAddress) query.getSingleResult();
            return listOfCfgMasterAddress;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
