...
public interface CfgDocumentRepository<T> extends SearchInterface {
    ...
    public List<T> findByCustomerType(String customerType) throws Exception, SpartanPersistenceException;
