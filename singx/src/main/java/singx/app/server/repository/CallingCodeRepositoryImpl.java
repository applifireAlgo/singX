...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CallingCode Master table Entity", complexity = Complexity.LOW)
public class CallingCodeRepositoryImpl extends SearchInterfaceImpl implements CallingCodeRepository<CallingCode> {
    ...
    @Override
    @Transactional
    public List<CallingCode> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.CallingCode> query = emanager.createQuery("select u from CallingCode u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CallingCode save(CallingCode entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CallingCode> save(List<CallingCode> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CallingCode obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.CallingCode s = emanager.find(singx.app.shared.singx.CallingCode.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CallingCode entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CallingCode> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CallingCode obj = entity.get(i);
    ...
    @Transactional
    public List<CallingCode> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CallingCode.findByCountryId");
            query.setParameter("countryId", countryId);
            java.util.List<singx.app.shared.singx.CallingCode> listOfCallingCode = query.getResultList();
            return listOfCallingCode;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public CallingCode findById(String mapId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CallingCode.findById");
            query.setParameter("mapId", mapId);
            singx.app.shared.singx.CallingCode listOfCallingCode = (singx.app.shared.singx.CallingCode) query.getSingleResult();
            return listOfCallingCode;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
