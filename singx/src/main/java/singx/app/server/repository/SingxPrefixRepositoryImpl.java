...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for SingxPrefix Master table Entity", complexity = Complexity.LOW)
public class SingxPrefixRepositoryImpl extends SearchInterfaceImpl implements SingxPrefixRepository<SingxPrefix> {
    ...
    @Override
    @Transactional
    public List<SingxPrefix> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.SingxPrefix> query = emanager.createQuery("select u from SingxPrefix u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public SingxPrefix save(SingxPrefix entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<SingxPrefix> save(List<SingxPrefix> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.SingxPrefix obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.SingxPrefix s = emanager.find(singx.app.shared.singx.SingxPrefix.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(SingxPrefix entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<SingxPrefix> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.SingxPrefix obj = entity.get(i);
    ...
    @Transactional
    public List<SingxPrefix> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SingxPrefix.findByCountryId");
            query.setParameter("countryId", countryId);
            java.util.List<singx.app.shared.singx.SingxPrefix> listOfSingxPrefix = query.getResultList();
            return listOfSingxPrefix;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public SingxPrefix findById(String prefixId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SingxPrefix.findById");
            query.setParameter("prefixId", prefixId);
            singx.app.shared.singx.SingxPrefix listOfSingxPrefix = (singx.app.shared.singx.SingxPrefix) query.getSingleResult();
            return listOfSingxPrefix;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
