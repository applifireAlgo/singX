...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for WireTransferMode Transaction table", complexity = Complexity.MEDIUM)
public class WireTransferModeRepositoryImpl extends SearchInterfaceImpl implements WireTransferModeRepository<WireTransferMode> {
    ...
    @Override
    @Transactional
    public List<WireTransferMode> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.WireTransferMode> query = emanager.createQuery("select u from WireTransferMode u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public WireTransferMode save(WireTransferMode entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<WireTransferMode> save(List<WireTransferMode> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.WireTransferMode obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.WireTransferMode s = emanager.find(singx.app.shared.singx.WireTransferMode.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(WireTransferMode entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<WireTransferMode> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.WireTransferMode obj = entity.get(i);
    ...
    @Transactional
    public List<WireTransferMode> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("WireTransferMode.findByCountryId");
            query.setParameter("countryId", countryId);
            java.util.List<singx.app.shared.singx.WireTransferMode> listOfWireTransferMode = query.getResultList();
            return listOfWireTransferMode;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public WireTransferMode findById(String wireTransferModeId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("WireTransferMode.findById");
            query.setParameter("wireTransferModeId", wireTransferModeId);
            singx.app.shared.singx.WireTransferMode listOfWireTransferMode = (singx.app.shared.singx.WireTransferMode) query.getSingleResult();
            return listOfWireTransferMode;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
