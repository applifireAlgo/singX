...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CompanyCategory Master table Entity", complexity = Complexity.LOW)
public class CompanyCategoryRepositoryImpl extends SearchInterfaceImpl implements CompanyCategoryRepository<CompanyCategory> {
    ...
    @Override
    @Transactional
    public List<CompanyCategory> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.CompanyCategory> query = emanager.createQuery("select u from CompanyCategory u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CompanyCategory save(CompanyCategory entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CompanyCategory> save(List<CompanyCategory> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CompanyCategory obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.CompanyCategory s = emanager.find(singx.app.shared.singx.CompanyCategory.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CompanyCategory entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CompanyCategory> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CompanyCategory obj = entity.get(i);
    ...
    @Transactional
    public List<CompanyCategory> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CompanyCategory.findByCountryId");
            query.setParameter("countryId", countryId);
            java.util.List<singx.app.shared.singx.CompanyCategory> listOfCompanyCategory = query.getResultList();
            return listOfCompanyCategory;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public CompanyCategory findById(String companyCategoryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CompanyCategory.findById");
            query.setParameter("companyCategoryId", companyCategoryId);
            singx.app.shared.singx.CompanyCategory listOfCompanyCategory = (singx.app.shared.singx.CompanyCategory) query.getSingleResult();
            return listOfCompanyCategory;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
