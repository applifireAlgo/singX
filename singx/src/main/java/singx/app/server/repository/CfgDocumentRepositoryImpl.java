...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CfgDocument Master table Entity", complexity = Complexity.LOW)
public class CfgDocumentRepositoryImpl extends SearchInterfaceImpl implements CfgDocumentRepository<CfgDocument> {
    ...
    @Override
    @Transactional
    public List<CfgDocument> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.CfgDocument> query = emanager.createQuery("select u from CfgDocument u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CfgDocument save(CfgDocument entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CfgDocument> save(List<CfgDocument> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CfgDocument obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.CfgDocument s = emanager.find(singx.app.shared.singx.CfgDocument.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CfgDocument entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CfgDocument> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CfgDocument obj = entity.get(i);
    ...
    @Transactional
    public List<CfgDocument> findByCustomerType(String customerType) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CfgDocument.findByCustomerType");
            query.setParameter("customerType", customerType);
            java.util.List<singx.app.shared.singx.CfgDocument> listOfCfgDocument = query.getResultList();
            return listOfCfgDocument;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public List<CfgDocument> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CfgDocument.findByCountryId");
    ...
    @Transactional
    public CfgDocument findById(String documentId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CfgDocument.findById");
            query.setParameter("documentId", documentId);
            singx.app.shared.singx.CfgDocument listOfCfgDocument = (singx.app.shared.singx.CfgDocument) query.getSingleResult();
            return listOfCfgDocument;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
