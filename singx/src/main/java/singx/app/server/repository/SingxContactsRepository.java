...
public interface SingxContactsRepository<T> extends SearchInterface {
    ...
    public List<T> findByPrefixId(String prefixId) throws Exception, SpartanPersistenceException;

    public List<T> findByGenderId(String genderId) throws Exception, SpartanPersistenceException;

    public List<T> findByPhoneCountryCode(String phoneCountryCode) throws Exception, SpartanPersistenceException;
