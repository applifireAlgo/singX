...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CustomerType Master table Entity", complexity = Complexity.LOW)
public class CustomerTypeRepositoryImpl extends SearchInterfaceImpl implements CustomerTypeRepository<CustomerType> {
    ...
    @Override
    @Transactional
    public List<CustomerType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.CustomerType> query = emanager.createQuery("select u from CustomerType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CustomerType save(CustomerType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CustomerType> save(List<CustomerType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CustomerType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.CustomerType s = emanager.find(singx.app.shared.singx.CustomerType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CustomerType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CustomerType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CustomerType obj = entity.get(i);
    ...
    @Transactional
    public CustomerType findById(String customerTypeId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CustomerType.findById");
            query.setParameter("customerTypeId", customerTypeId);
            singx.app.shared.singx.CustomerType listOfCustomerType = (singx.app.shared.singx.CustomerType) query.getSingleResult();
