...
public interface CfgCountryAddressRepository<T> extends SearchInterface {
    ...
    public List<T> findByInputTypeId(Integer inputTypeId) throws Exception, SpartanPersistenceException;
