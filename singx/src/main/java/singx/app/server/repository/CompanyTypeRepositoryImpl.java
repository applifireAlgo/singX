...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for CompanyType Master table Entity", complexity = Complexity.LOW)
public class CompanyTypeRepositoryImpl extends SearchInterfaceImpl implements CompanyTypeRepository<CompanyType> {
    ...
    @Override
    @Transactional
    public List<CompanyType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.CompanyType> query = emanager.createQuery("select u from CompanyType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public CompanyType save(CompanyType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<CompanyType> save(List<CompanyType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CompanyType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.CompanyType s = emanager.find(singx.app.shared.singx.CompanyType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(CompanyType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<CompanyType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.CompanyType obj = entity.get(i);
    ...
    @Transactional
    public CompanyType findById(String companyTypeId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("CompanyType.findById");
            query.setParameter("companyTypeId", companyTypeId);
            singx.app.shared.singx.CompanyType listOfCompanyType = (singx.app.shared.singx.CompanyType) query.getSingleResult();
