...
public interface WireTransferModeRepository<T> extends SearchInterface {
    ...
    public T findById(String wireTransferModeId) throws Exception, SpartanPersistenceException;
}
