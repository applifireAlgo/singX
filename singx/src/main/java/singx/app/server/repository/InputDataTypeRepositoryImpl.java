...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for InputDataType Master table Entity", complexity = Complexity.LOW)
public class InputDataTypeRepositoryImpl extends SearchInterfaceImpl implements InputDataTypeRepository<InputDataType> {
    ...
    @Override
    @Transactional
    public List<InputDataType> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.InputDataType> query = emanager.createQuery("select u from InputDataType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public InputDataType save(InputDataType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<InputDataType> save(List<InputDataType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.InputDataType obj = entity.get(i);
    ...
    public void delete(Integer id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.InputDataType s = emanager.find(singx.app.shared.singx.InputDataType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(InputDataType entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<InputDataType> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.InputDataType obj = entity.get(i);
    ...
    @Transactional
    public InputDataType findById(Integer inputTypeId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("InputDataType.findById");
            query.setParameter("inputTypeId", inputTypeId);
            singx.app.shared.singx.InputDataType listOfInputDataType = (singx.app.shared.singx.InputDataType) query.getSingleResult();
            return listOfInputDataType;
        } catch (javax.persistence.PersistenceException e) {
