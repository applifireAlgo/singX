...
public interface CompanyCategoryRepository<T> extends SearchInterface {
    ...
    public T findById(String companyCategoryId) throws Exception, SpartanPersistenceException;
}
