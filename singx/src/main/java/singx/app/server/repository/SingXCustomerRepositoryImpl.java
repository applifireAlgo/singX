...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for SingXCustomer Transaction table", complexity = Complexity.MEDIUM)
public class SingXCustomerRepositoryImpl extends SearchInterfaceImpl implements SingXCustomerRepository<SingXCustomer> {
    ...
    @Override
    @Transactional
    public List<SingXCustomer> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.SingXCustomer> query = emanager.createQuery("select u from SingXCustomer u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public SingXCustomer save(SingXCustomer entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<SingXCustomer> save(List<SingXCustomer> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.SingXCustomer obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.SingXCustomer s = emanager.find(singx.app.shared.singx.SingXCustomer.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(SingXCustomer entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<SingXCustomer> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.SingXCustomer obj = entity.get(i);
    ...
    @Transactional
    public SingXCustomer findById(String customerId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("SingXCustomer.findById");
            query.setParameter("customerId", customerId);
            singx.app.shared.singx.SingXCustomer listOfSingXCustomer = (singx.app.shared.singx.SingXCustomer) query.getSingleResult();
            return listOfSingXCustomer;
        } catch (javax.persistence.PersistenceException e) {
