...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for UserContactMap Transaction table", complexity = Complexity.MEDIUM)
public class UserContactMapRepositoryImpl extends SearchInterfaceImpl implements UserContactMapRepository<UserContactMap> {
    ...
    @Override
    @Transactional
    public List<UserContactMap> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.UserContactMap> query = emanager.createQuery("select u from UserContactMap u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public UserContactMap save(UserContactMap entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<UserContactMap> save(List<UserContactMap> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.UserContactMap obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.UserContactMap s = emanager.find(singx.app.shared.singx.UserContactMap.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(UserContactMap entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<UserContactMap> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.UserContactMap obj = entity.get(i);
    ...
    @Transactional
    public List<UserContactMap> findByContactId(String contactId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("UserContactMap.findByContactId");
            query.setParameter("contactId", contactId);
            java.util.List<singx.app.shared.singx.UserContactMap> listOfUserContactMap = query.getResultList();
            return listOfUserContactMap;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public UserContactMap findById(String mapId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("UserContactMap.findById");
            query.setParameter("mapId", mapId);
            singx.app.shared.singx.UserContactMap listOfUserContactMap = (singx.app.shared.singx.UserContactMap) query.getSingleResult();
            return listOfUserContactMap;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
