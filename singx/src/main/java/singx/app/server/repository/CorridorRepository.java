...
public interface CorridorRepository<T> extends SearchInterface {
    ...
    public List<T> findByToCountryId(String toCountryId) throws Exception, SpartanPersistenceException;

    public List<T> findByCountryId(String countryId) throws Exception, SpartanPersistenceException;

    public T findById(String corridorId) throws Exception, SpartanPersistenceException;
}
