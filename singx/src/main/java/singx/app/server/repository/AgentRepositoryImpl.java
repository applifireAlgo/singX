...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Agent Transaction table", complexity = Complexity.MEDIUM)
public class AgentRepositoryImpl extends SearchInterfaceImpl implements AgentRepository<Agent> {
    ...
    @Override
    @Transactional
    public List<Agent> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<singx.app.shared.singx.Agent> query = emanager.createQuery("select u from Agent u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Agent save(Agent entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Agent> save(List<Agent> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.Agent obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            singx.app.shared.singx.Agent s = emanager.find(singx.app.shared.singx.Agent.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Agent entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Agent> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                singx.app.shared.singx.Agent obj = entity.get(i);
    ...
    @Transactional
    public List<Agent> findByContactId(String contactId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Agent.findByContactId");
            query.setParameter("contactId", contactId);
            java.util.List<singx.app.shared.singx.Agent> listOfAgent = query.getResultList();
            return listOfAgent;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public List<Agent> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Agent.findByCountryId");
    ...
    @Transactional
    public Agent findById(String agentId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Agent.findById");
            query.setParameter("agentId", agentId);
            singx.app.shared.singx.Agent listOfAgent = (singx.app.shared.singx.Agent) query.getSingleResult();
            return listOfAgent;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
