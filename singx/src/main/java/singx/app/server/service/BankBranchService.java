...
public abstract class BankBranchService {

    public HttpEntity<ResponseBean> findAll() throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> save(BankBranch entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> save(List<BankBranch> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
    ...
    public HttpEntity<ResponseBean> update(BankBranch entity) throws Exception, SpartanPersistenceException {
        return null;
    }

    public HttpEntity<ResponseBean> update(List<BankBranch> entity, boolean isArray) throws Exception, SpartanPersistenceException {
        return null;
    }
