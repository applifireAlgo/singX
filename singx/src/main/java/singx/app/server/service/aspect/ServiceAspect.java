package singx.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* singx.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* singx.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* singx.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* singx.app.server.service..*..*(..)) && !within(singx.app.server.service.sessionmgt.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* singx.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* singx.app.server.service..get*(..))")
