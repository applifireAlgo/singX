...
@RequestMapping("/UserContactMapServiceWS")
public class UserContactMapServiceWS {

    @Autowired
    private UserContactMapService usercontactmapservice;

    @RequestMapping(value = "/getConatctInfo", consumes = "application/json", method = RequestMethod.POST)
    public HttpEntity<ResponseBean> getConatctInfo() throws Exception, SpartanBusinessValidationFailedException, SpartanDataNotFoundException, SpartanIncorrectDataException, SpartanPersistenceException {
