Ext.define('Buzzor.singx.web.singx.controller.singx.CfgMasterAddressMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.CfgMasterAddressMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#CfgMasterAddressTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#CfgMasterAddress');
          var grid = this.view.down('#CfgMasterAddressGrid');
          var tree = this.view.down('#CfgMasterAddressTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#CfgMasterAddressGrid');
               ...
               var formPanel = this.getView().up().down("#CfgMasterAddress");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#CfgMasterAddressTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CfgMasterAddress').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CfgMasterAddressGrid').store;
          gridStore.removeAll();
     ...
     loadData: function(responseData) {
          this.view.down('#CfgMasterAddress').getViewModel().setData(responseData.response.data);
     },
