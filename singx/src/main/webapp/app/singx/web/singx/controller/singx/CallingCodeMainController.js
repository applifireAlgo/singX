Ext.define('Buzzor.singx.web.singx.controller.singx.CallingCodeMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.CallingCodeMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#CallingCodeTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#CallingCode');
          var grid = this.view.down('#CallingCodeGrid');
          var tree = this.view.down('#CallingCodeTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#CallingCodeGrid');
               ...
               var formPanel = this.getView().up().down("#CallingCode");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#CallingCodeTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CallingCode').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CallingCodeGrid').store;
          gridStore.removeAll();
     ...
     loadData: function(responseData) {
          this.view.down('#CallingCode').getViewModel().setData(responseData.response.data);
     },
