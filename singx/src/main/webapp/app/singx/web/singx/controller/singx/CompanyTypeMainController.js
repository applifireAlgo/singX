Ext.define('Buzzor.singx.web.singx.controller.singx.CompanyTypeMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.CompanyTypeMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#CompanyTypeTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#CompanyType');
          var grid = this.view.down('#CompanyTypeGrid');
          var tree = this.view.down('#CompanyTypeTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#CompanyTypeGrid');
               ...
               var formPanel = this.getView().up().down("#CompanyType");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#CompanyTypeTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CompanyType').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CompanyTypeGrid').store;
          gridStore.removeAll();
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.companyTypeId = grid.store.data.items[rowIndex].data.companyTypeId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
     ...
     loadData: function(responseData) {
          this.view.down('#CompanyType').getViewModel().setData(responseData.response.data);
     },
