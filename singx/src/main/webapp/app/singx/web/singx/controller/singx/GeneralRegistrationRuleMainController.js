Ext.define('Buzzor.singx.web.singx.controller.singx.GeneralRegistrationRuleMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.GeneralRegistrationRuleMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#GeneralRegistrationRuleTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#GeneralRegistrationRule');
          var grid = this.view.down('#GeneralRegistrationRuleGrid');
          var tree = this.view.down('#GeneralRegistrationRuleTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#GeneralRegistrationRuleGrid');
               ...
               var formPanel = this.getView().up().down("#GeneralRegistrationRule");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#GeneralRegistrationRuleTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#GeneralRegistrationRule').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#GeneralRegistrationRuleGrid').store;
          gridStore.removeAll();
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.configId = grid.store.data.items[rowIndex].data.configId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
     ...
     loadData: function(responseData) {
          this.view.down('#GeneralRegistrationRule').getViewModel().setData(responseData.response.data);
     },
