Ext.define('Buzzor.singx.web.singx.controller.contacts.ContactTypeMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.contactTypeId = grid.store.data.items[rowIndex].data.contactTypeId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
