Ext.define('Buzzor.singx.web.singx.controller.customers.AppCustomerMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.appCustomerId = grid.store.data.items[rowIndex].data.appCustomerId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
