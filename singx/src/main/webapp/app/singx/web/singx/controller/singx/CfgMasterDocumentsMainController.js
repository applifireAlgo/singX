Ext.define('Buzzor.singx.web.singx.controller.singx.CfgMasterDocumentsMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.CfgMasterDocumentsMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#CfgMasterDocumentsTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#CfgMasterDocuments');
          var grid = this.view.down('#CfgMasterDocumentsGrid');
          var tree = this.view.down('#CfgMasterDocumentsTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#CfgMasterDocumentsGrid');
               ...
               var formPanel = this.getView().up().down("#CfgMasterDocuments");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#CfgMasterDocumentsTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CfgMasterDocuments').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CfgMasterDocumentsGrid').store;
          gridStore.removeAll();
     ...
     loadData: function(responseData) {
          this.view.down('#CfgMasterDocuments').getViewModel().setData(responseData.response.data);
     },
