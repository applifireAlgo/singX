Ext.define('Buzzor.singx.web.singx.controller.location.AddressTypeMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.addressTypeId = grid.store.data.items[rowIndex].data.addressTypeId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
