Ext.define('Buzzor.singx.web.singx.controller.authentication.PasswordPolicyMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.policyId = grid.store.data.items[rowIndex].data.policyId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
