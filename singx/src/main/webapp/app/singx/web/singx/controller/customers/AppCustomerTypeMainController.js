Ext.define('Buzzor.singx.web.singx.controller.customers.AppCustomerTypeMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.appcustTypeId = grid.store.data.items[rowIndex].data.appcustTypeId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
