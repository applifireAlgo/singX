Ext.define('Buzzor.singx.web.singx.controller.singx.CompanyCategoryMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.CompanyCategoryMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#CompanyCategoryTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#CompanyCategory');
          var grid = this.view.down('#CompanyCategoryGrid');
          var tree = this.view.down('#CompanyCategoryTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#CompanyCategoryGrid');
               ...
               var formPanel = this.getView().up().down("#CompanyCategory");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#CompanyCategoryTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CompanyCategory').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CompanyCategoryGrid').store;
          gridStore.removeAll();
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.companyCategoryId = grid.store.data.items[rowIndex].data.companyCategoryId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
     ...
     loadData: function(responseData) {
          this.view.down('#CompanyCategory').getViewModel().setData(responseData.response.data);
     },
