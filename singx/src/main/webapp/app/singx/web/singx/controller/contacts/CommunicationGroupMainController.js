Ext.define('Buzzor.singx.web.singx.controller.contacts.CommunicationGroupMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.commGroupId = grid.store.data.items[rowIndex].data.commGroupId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
