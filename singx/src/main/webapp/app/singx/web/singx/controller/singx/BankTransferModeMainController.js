Ext.define('Buzzor.singx.web.singx.controller.singx.BankTransferModeMainController', {
     extend: 'Buzzor.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.BankTransferModeMainController',
     init: function() {
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#BankTransferModeTree');
               ...
               var compRef = this.view.down('#BankTransferModeTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#BankTransferMode');
          var grid = this.view.down('#BankTransferModeGrid');
          var tree = this.view.down('#BankTransferModeTreeContainer');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#BankTransferModeTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var BankTransferMode = this.view.down('#BankTransferModeForm');
               BankTransferMode.reset();
               var gridPanel = this.view.down('#BankTransferModeGrid');
          ...
          var formPanel = this.getView().up().down('#BankTransferModeForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#BankTransferModeTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#BankTransferMode').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#BankTransferModeGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
     ...
     loadData: function(responseData) {
          this.view.down('#BankTransferModeForm').getViewModel().setData(responseData.response.data);
     },
