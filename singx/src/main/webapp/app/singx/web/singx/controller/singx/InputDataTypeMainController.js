Ext.define('Buzzor.singx.web.singx.controller.singx.InputDataTypeMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.InputDataTypeMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#InputDataTypeTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#InputDataType');
          var grid = this.view.down('#InputDataTypeGrid');
          var tree = this.view.down('#InputDataTypeTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#InputDataTypeGrid');
               ...
               var formPanel = this.getView().up().down("#InputDataType");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#InputDataTypeTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#InputDataType').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#InputDataTypeGrid').store;
          gridStore.removeAll();
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.inputTypeId = grid.store.data.items[rowIndex].data.inputTypeId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
     ...
     loadData: function(responseData) {
          this.view.down('#InputDataType').getViewModel().setData(responseData.response.data);
     },
