Ext.define('Buzzor.singx.web.singx.controller.singx.CfgDocCntIndividualMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.CfgDocCntIndividualMainController',
     ...
     onCountryIdChange: function(me, newValue, oldValue, eOpts) {
          this.onCountryIdChangeResidenceTypeId(me, newValue, oldValue, eOpts);
     },
     onCountryIdChangeResidenceTypeId: function(me, newValue, oldValue, eOpts) {
          debugger;
          var scope = this.getView();
          Ext.Ajax.request({
               async: false,
               url: 'secure/ResidenceType/findByCountryId',
               method: 'POST',
               jsonData: {
                    findKey: newValue
               },
               ...
               element: me,
               success: function(response, scope) {
                    var residenceTypeIdCombo = scope.element.up('form').down('#residenceTypeId');
                    scope.sender.controller.assignComboData(residenceTypeIdCombo, response.responseText);
                    scope.sender.controller.addCommunicationLog(response, true, residenceTypeIdCombo);
               },
               failure: function(response, scope) {
                    debugger;
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#CfgDocCntIndividualTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#CfgDocCntIndividual');
          var grid = this.view.down('#CfgDocCntIndividualGrid');
          var tree = this.view.down('#CfgDocCntIndividualTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#CfgDocCntIndividualGrid');
               ...
               var formPanel = this.getView().up().down("#CfgDocCntIndividual");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#CfgDocCntIndividualTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CfgDocCntIndividual').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CfgDocCntIndividualGrid').store;
          gridStore.removeAll();
     ...
     loadData: function(responseData) {
          this.view.down('#CfgDocCntIndividual').getViewModel().setData(responseData.response.data);
     },
