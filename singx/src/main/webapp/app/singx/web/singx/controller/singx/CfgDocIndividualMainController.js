Ext.define('Buzzor.singx.web.singx.controller.singx.CfgDocIndividualMainController', {
     extend: 'Buzzor.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.CfgDocIndividualMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#CfgDocIndividualTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#CfgDocIndividual');
          var grid = this.view.down('#CfgDocIndividualGrid');
          var tree = this.view.down('#CfgDocIndividualTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#CfgDocIndividualGrid');
               ...
               var formPanel = this.getView().up().down("#CfgDocIndividual");
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#CfgDocIndividualTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CfgDocIndividual').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CfgDocIndividualGrid').store;
          gridStore.removeAll();
     ...
     loadData: function(responseData) {
          this.view.down('#CfgDocIndividual').getViewModel().setData(responseData.response.data);
     },
