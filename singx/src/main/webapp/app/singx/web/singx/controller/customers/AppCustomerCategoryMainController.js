Ext.define('Buzzor.singx.web.singx.controller.customers.AppCustomerCategoryMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.appcustCategoryId = grid.store.data.items[rowIndex].data.appcustCategoryId;
          me = this;
          Ext.MessageBox.confirm({
               title: 'Confirm',
               msg: 'Delete Feature',
