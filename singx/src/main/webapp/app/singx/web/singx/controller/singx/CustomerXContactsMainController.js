Ext.define('Buzzor.singx.web.singx.controller.singx.CustomerXContactsMainController', {
     extend: 'Buzzor.view.fw.frameworkController.RegistrationGridViewController',
     alias: 'controller.CustomerXContactsMainController',
     init: function() {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var jsonData = {};
          jsonData.mapPk = grid.store.data.items[rowIndex].data.mapPk;
          me = this;
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          debugger;
          var formPanel = this.getView().down('#CustomerXContacts');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CustomerXContacts').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CustomerXContactsGrid').store;
          gridStore.removeAll();
