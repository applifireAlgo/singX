Ext.define('Buzzor.singx.web.singx.controller.singx.UserContactMapMainController', {
     extend: 'Buzzor.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.UserContactMapMainController',
     init: function() {
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#UserContactMapTree');
               ...
               var compRef = this.view.down('#UserContactMapTree');
     ...
     hideDataBrowser: function() {
          debugger;
          var form = this.view.down('#UserContactMap');
          var grid = this.view.down('#UserContactMapGrid');
          var tree = this.view.down('#UserContactMapTreeContainer');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#UserContactMapTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var UserContactMap = this.view.down('#UserContactMapForm');
               UserContactMap.reset();
               var gridPanel = this.view.down('#UserContactMapGrid');
          ...
          var formPanel = this.getView().up().down('#UserContactMapForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#UserContactMapTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#UserContactMap').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#UserContactMapGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
     ...
     loadData: function(responseData) {
          this.view.down('#UserContactMapForm').getViewModel().setData(responseData.response.data);
     },
