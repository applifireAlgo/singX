Ext.define('Buzzor.singx.web.singx.view.contacts.CoreContactsMain', {
     ...
     "requires": ["Buzzor.singx.shared.singx.model.contacts.CoreContactsModel", "Buzzor.singx.web.singx.controller.contacts.CoreContactsMainController", "Buzzor.singx.shared.singx.model.contacts.TitleModel", "Buzzor.singx.shared.singx.model.location.LanguageModel", "Buzzor.singx.shared.singx.model.contacts.GenderModel", "Buzzor.singx.shared.singx.model.location.TimezoneModel", "Buzzor.singx.shared.singx.model.contacts.CommunicationGroupModel", "Buzzor.singx.shared.singx.model.contacts.CommunicationTypeModel", "Buzzor.singx.shared.singx.model.location.AddressTypeModel", "Buzzor.singx.shared.singx.model.location.CountryModel", "Buzzor.singx.shared.singx.model.location.StateModel", "Buzzor.singx.shared.singx.model.location.CityModel", "Buzzor.singx.shared.singx.viewmodel.contacts.CoreContactsViewModel", "Ext.form.field.CustomDateField"],
     "communicationLog": [],
     "tabPosition": "bottom",
     "items": [{
          "title": "Data Browser",
