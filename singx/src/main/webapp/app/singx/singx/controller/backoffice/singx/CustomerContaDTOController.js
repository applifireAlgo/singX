Ext.define('Buzzor.singx.singx.controller.backoffice.singx.CustomerContaDTOController', {
     extend: 'Ext.app.ViewController',
     alias: 'controller.CustomerContaDTOController',
     saveForm: function(but, evt) {
          ...
          var me = this;
          Ext.Ajax.request({
               url: 'secure/CorporateCustomerServiceWS/genCustomer',
               method: 'POST',
               jsonData: jsonData,
